    ...
    <form:form modelAttribute="editEmailForm" action="${postPath}" method="post">
        <div class="card card-content">
            <div style="margin-bottom: 5%;">
                <span class="presentation-text" style="color: #171616;"><spring:message code="Editrestaurant.mail"/></span>
            </div>
            <div class="disName">
            ...
            <div class="submit center">
                ...
                <input type="submit" value="${label}" class="btn confirm-btn" style="margin-top: 2%;" onclick="this.form.submit(); this.disabled=true;this.value=${label2}; "/>
            </div>
        </div>
    </form:form>
</div>
