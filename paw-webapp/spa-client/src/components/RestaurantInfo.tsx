...
const RestaurantInfo: FC<Props> = ({user, restaurant, reloadInfo}): JSX.Element => {
    ...
    return (
      ...
      >
        <Grid
          ...
          margin={2}
        >
          <AccountInfoForm user={user} data={restaurant} isOpen={isOpenAccountForm} handleOpen={handleOpenAccountForm} reload={reloadInfo}/>
