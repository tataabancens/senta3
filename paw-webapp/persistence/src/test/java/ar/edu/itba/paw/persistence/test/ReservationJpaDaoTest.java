...
public class ReservationJpaDaoTest {
    ...
    public void testGetAllReservationsOrderedBy_invalidString1(){
        ...
        // 2. Ejercitacion
        List<Reservation> allReservations = reservationDao.getAllReservationsOrderedBy(1, "XXXXXX", "ASC", "1", 1, 0);
    ...
    public void testGetAllReservationsOrderedBy_invalidString2(){
        ...
        // 2. Ejercitacion
        List<Reservation> allReservations = reservationDao.getAllReservationsOrderedBy(1, "reservationid", "XXXX", "1", 1, 0);
    ...
    public void testGetAllReservationsOrderedBy_invalidString3(){
        ...
        // 2. Ejercitacion
        List<Reservation> allReservations = reservationDao.getAllReservationsOrderedBy(1, "reservationid", "ASC", "XXXXXX", 1, 0);
    ...
    public void testGetAllReservationsOrderedBy_valid(){
        ...
        // 2. Ejercitacion
        List<Reservation> allReservations = reservationDao.getAllReservationsOrderedBy(1, "reservationid", "ASC", "9", 1, 0);
