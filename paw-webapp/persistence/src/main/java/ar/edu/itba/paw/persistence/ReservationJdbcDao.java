...
public class ReservationJdbcDao implements ReservationDao {
    ...
    public Optional<Reservation> getReservationById(long id) {
        List<Reservation> query = jdbcTemplate.query("SELECT * FROM restaurant WHERE restaurantId", new Object[]{id}, ROW_MAPPER);
        return query.stream().findFirst();
    }
    @Override
    public Reservation create(long restaurantId, Timestamp reservationDate) {
